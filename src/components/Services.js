  ...
  const services = [
    {
      ...
      description: "Transform your business with cutting-edge digital solutions tailored to your specific needs and goals.",
      icon: (
    ...
    },
    {
      ...
      description: "Leverage the power of cloud computing to scale your business and improve operational efficiency.",
      icon: (
        <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Implement intelligent solutions that help automate processes and derive insights from your data.",
      icon: (
        <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
